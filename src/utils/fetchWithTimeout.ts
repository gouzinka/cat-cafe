/*
    isomorphic-fetch doesn't support custom timeout, so we wrap it in our own function
    Otherwise we would rely on browser's behaviour 300ms (Chrome), 90s (Firefox)
